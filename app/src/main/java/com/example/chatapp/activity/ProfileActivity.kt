...
class ProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databaseReference =
            FirebaseDatabase.getInstance("https://chat-app-ca125-default-rtdb.firebaseio.com").getReference("Users").child(firebaseUser.uid)

        storage = FirebaseStorage.getInstance("gs://chat-app-ca125.appspot.com")
